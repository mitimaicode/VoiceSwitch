...
<p align="center">
  <a href="assets/voiceswitch-demo.mp4">
    <img src="assets/voiceswitch-demo.gif" alt="VoiceSwitch: запись, локальная расшифровка, режим «Кратко» и автоматическая вставка" width="900">
  </a>
</p>

В демонстрации GigaAM распознаёт русскую фразу, локальная Qwen3-4B сокращает
её, а готовое сообщение автоматически появляется в поле. [Версия со
звуком](assets/voiceswitch-demo.mp4).
